...
class CategoriesController extends AbstractController
{
    ...
    #[Route('/{idCategory}', name: 'app_categories_show', methods: ['GET'])]
    ...
    #[Route('/{idCategory}/edit', name: 'app_categories_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idCategory}', name: 'app_categories_delete', methods: ['POST'])]
